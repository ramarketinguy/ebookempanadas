        ...
        <div className="relative z-10 container mx-auto px-6 pt-20 pb-12 text-center text-white">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-4xl mx-auto">
            <motion.p variants={fadeIn} className="text-[#F2E8DF] uppercase tracking-widest font-bold text-sm md:text-base mb-4 inline-block bg-[#A63C3C] px-4 py-1 rounded-full">
              ¡Dejá de comprar discos de supermercado rotos y secos!
            </motion.p>
            <motion.h1 variants={fadeIn} className="font-serif text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight text-white drop-shadow-lg">
              ...
              <span className="block text-[#D4AF37] italic mt-2">Masas que no se abren y rellenos que explotan de sabor.</span>
            </motion.h1>
            <motion.p variants={fadeIn} className="text-lg md:text-xl text-gray-200 mb-10 max-w-2xl mx-auto leading-relaxed">
              Aprendé paso a paso las recetas definitivas de la masa casera (Clásica, Integral y Sin Gluten) y descubrí combinaciones de rellenos salados y dulces que van a ser el éxito de cualquier juntada.
            </motion.p>
            ...
            <motion.div variants={fadeIn} className="flex flex-col items-center gap-4">
              ...
              <p className="text-[#F2E8DF] font-medium text-lg mt-2 font-serif italic">
                <span className="line-through opacity-70">Valor Real: $25 USD</span> <span className="text-[#D4AF37] text-xl not-italic font-bold ml-2 border-b border-[#D4AF37] pb-0.5">Hoy: $12 USD</span>
              </p>
            </motion.div>
          </motion.div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <ul className="space-y-4">
                {[
                  "Masas caseras y económicas que podés freezar sin drama.",
                  "El paso a paso exacto para que la masa Sin TACC no se te quiebre.",
                  "Rellenos jugosos y sabrosos, desde carne hasta pollo cremoso.",
                  "¡El postre resuelto para el mate! Rellenos dulces que te van a volar la cabeza."
                ].map((benefit, i) => (
      ...
      <section id="precio" className="py-24 bg-[#F2E8DF] px-6 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl relative z-10 text-center">
          ...
          >
            ...
            <h2 className="font-serif text-3xl md:text-5xl font-bold text-[#A63C3C] mb-6">
              El arte de las empanadas, en tus manos hoy.
            </h2>
            <p className="text-xl text-[#2B2B2B]/80 mb-8 max-w-2xl mx-auto">
              Aprender todos estos secretos en un curso de gastronomía te costaría más de $50 USD. Hoy podés llevarte todas las recetas probadas por menos de lo que sale pedir una sola docena de empanadas.
            </p>

            <div className="flex flex-col items-center gap-2 mb-10">
              <div className="text-5xl md:text-7xl font-bold text-[#2B2B2B] font-serif">$12 <span className="text-2xl font-sans font-medium text-[#2B2B2B]/60">USD</span></div>
              <div className="text-lg font-medium text-[#D96E4C] line-through decoration-2 decoration-[#D96E4C]/50 mt-1">Precio normal: $25 USD</div>
            </div>
            ...
            <p className="text-[#2B2B2B]/60 text-sm flex items-center justify-center gap-2 mt-4 font-medium">
              <CheckCircle2 className="w-4 h-4 text-[#D96E4C]" /> Acceso inmediato después del pago.
            </p>
